...
import 'package:to_do_list/components/custom_app_bar.dart';
import 'package:to_do_list/tasks/presentation/bloc/tasks_bloc.dart';
import 'package:to_do_list/components/build_text_field.dart';
import 'package:to_do_list/tasks/presentation/widget/task_item_view.dart';
              ...
              PopupMenuButton<int>(
                ...
                onSelected: (value) {
                  switch (value) {
                    ...
                    case 3: // Handle the new "Priority" case
                      {
                        context.read<TasksBloc>().add(SortTaskEvent(sortOption: 3));
                        break;
                      }
                  }
                },
                itemBuilder: (BuildContext context) {
                  return [
                    ...
                    PopupMenuItem<int>( // New Priority item
                      value: 3,
                      child: Row(
                        children: [
                          SvgPicture.asset(
                            'assets/svgs/horizontal_menu.svg', // Replace with your priority icon
                            width: 15,
                          ),
                          const SizedBox(
                            width: 10,
