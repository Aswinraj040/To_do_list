                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: () {
                                  // Create a new TaskModel with updated values, retaining the existing values if not changed
                                  var taskModel = TaskModel(
                                      id: widget.taskModel.id,  // Retain the original task ID
                                      title: title.text,        // Update the task title
                                      description: description.text,  // Update the task description
                                      startDateTime: _rangeStart,
                                      priority: widget.taskModel.priority,  // Retain the completed status// Update the start date and time
                                      completed: widget.taskModel.completed
                                  );

                                  // Dispatch the UpdateTaskEvent to update the task in the SQL database via TasksBloc
